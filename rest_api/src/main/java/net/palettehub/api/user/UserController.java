...
public class UserController {
    ...
    public ResponseEntity<String> auth(){
        return new ResponseEntity<String>(userService.createUser(new User()), HttpStatus.OK);
    }
    ...
    public ResponseEntity<PaletteList> getUserLikes(@PathVariable("userId") String userId, @RequestParam(name = "page", defaultValue = "1") String page){
        return new ResponseEntity<PaletteList>(userService.getLikedPalettes(userId, page), HttpStatus.OK);
    }
